...
# Enable CORS so your HTML/JS frontend can send requests
app.add_middleware(
    CORSMiddleware,
...
# Global memory to store vector database and chain between requests
app_state = {
    "vector_store": None,
    "rag_chain": None,
    "chunks_count": 0
...
async def ask_question(req: QuestionRequest):
    ...
    try:
        ...
        # Retrieve sources to display in the UI
